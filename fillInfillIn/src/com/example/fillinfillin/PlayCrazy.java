...
public class PlayCrazy extends Activity {
	...
	protected static int[][][] bitmapId ;	// fillBase Resource 배열
	protected static int checkCnt ;
	protected static boolean[][][] coord ;	// flood 상태
	protected static Bitmap[] img ;	// fillBace 배열
	...
	private ProgressBar timebar, loader ;	// 타이머
	...
	public void replayClick (View v)
	{
		...
		Intent replay =new Intent (PlayCrazy.this, Replay.class) ;	// Intent 설정
	...
	public void onWindowFocusChanged(boolean hasFocus)
	{
		...
		if (hasFocus == true) {	// Activity가 불러오기 전 일때
		}
	}
